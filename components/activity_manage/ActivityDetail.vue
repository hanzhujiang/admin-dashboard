                    ...
                    <el-row :gutter="10">
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <div class="form-group">
                          ...
                          <div class="content">
                            <el-date-picker :disabled="readonly"  size="small" v-model="isFormData.startdate"
                            @blur="validatorBlur('startdate',1)"
                            format="dd/MM/yyyy"
                             type="date" placeholder="" :picker-options="pickerOptions0">
                            </el-date-picker>
                          </div>
                      ...
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <div class="form-group">
                          ...
                          <div class="content">
                            <el-date-picker :disabled="readonly" size="small" v-model="isFormData.enddate"
                            @blur="validatorBlur('enddate',1)"
                            format="dd/MM/yyyy"
                             type="date" placeholder="" :picker-options="pickerOptions0">
                            </el-date-picker>
                      ...
                      <el-col :xs="24" :sm="24" :md="6" :lg="6" :xl="6">
                        <div class="form-group">
                          ...
                          <div class="content">
                            <el-time-select :disabled="readonly"  size="small" v-model="isFormData.starttime" 
                            @blur="validatorBlur('starttime',1)"
                            :picker-options="{
                                    start: '00:00',
                                    step: '00:15',
                                    end: '23:45'
                    ...
                    <el-row :gutter="10">
                      <el-col :span="24">
                        <div class="form-group">
                          ...
                          <div class="content">
                            <el-select :disabled="readonly" size="small" style="width:100%" v-model="isFormData.departmentids" multiple filterable allow-create default-first-option placeholder="">
                    ...
                    <el-row :gutter="10">
                      <el-col :span="24">
                        <div class="form-group">
                          ...
                          <div class="content">
                            <!-- @change="alertValue4($event,'strValue',5000)" -->
                             <quill-editor :options="editorOption"   :disabled="readonly"  v-model="formData.contents"></quill-editor>
...
export default {
  ...
  methods: {
    ...
    echo() {
      getActivity({
        ...
        if (res.data.success) {
          ...
          this.isFormData.startdate = this.toDate(res.data.activitydata.startdate)
          this.isFormData.starttime = this.toTime(res.data.activitydata.startdate)
          this.isFormData.enddate = this.toDate(res.data.activitydata.enddate)
          this.isFormData.endtime = this.toTime(res.data.activitydata.enddate)
          if(res.data.activitydata.attendtype == 1){
            this.allAgents('0');
          }else{
    ...
    handleSave() {
      ...
      if (
        !this.CompareItem(this.isFormData.starttime, this.isFormData.endtime)
      ) {
      ...
      if (
        !this.CompareDate(this.isFormData.startdate, this.isFormData.enddate)
      ) {
      ...
      let startdate =formatDate(new Date(this.isFormData.startdate),"yyyy-MM-dd") +" " +this.isFormData.starttime;
      let enddate = formatDate(new Date(this.isFormData.enddate), "yyyy-MM-dd") + " " +this.isFormData.endtime;
    ...
    allAgents(type) {
      ...
      if (type == "0") {
        this.formData.isallagent = 0
        this.options5.forEach(val => {
          this.isFormData.departmentids.push(val.departmentid);
        });
      }else{
        this.formData.isallagent = 1;
      }
    },
    setmap() {
      this.mod = false;
