              ...
              <div class="box-body">
                ...
                <el-row :gutter="20" class="line2">
                  ...
                  <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <div class="content">{{fromagency.contactperson?fromagency.contactperson:'-'}}</div>
                  </el-col>
                  <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                    <div class="title">{{rs.contact_number}}</div>
                  </el-col>
                  <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <div class="content">{{fromagency.contactnumber?fromagency.contactnumber:'-'}}</div>
                  </el-col>
                </el-row>    
                <el-row :gutter="20" class="line2">
                  <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                  ...
                  <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <div class="content">{{fromagency.officetelephone?fromagency.officetelephone:'-'}}</div>
                  </el-col>
                  <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                    <div class="title">{{rs.office_fax}}</div>
                  </el-col>
                  <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <div class="content">{{fromagency.officefax?fromagency.officefax:'-'}}</div>
                  </el-col>
                </el-row>    
                <el-row :gutter="20" class="line2">
                  <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
        ...
        <el-col :span="24">
          <div class="box">
            <!-- <div class="box-header clearfix ">
              <div class="box-title">
                <i class="fa fa-cube"><span>{{rs.agency_commission_rate}}</span></i>
              </div>
              <div class="box-tools">
                    ...
                    <template slot-scope="scope">
                      <el-row :gutter="5" class="line2">
                        ...
                        <el-col :xs="24" :sm="24" :md="4" :lg="4" :xl="4">
                          <div class="title">
                            <img class="icon" src="@/assets/imgs/common/unfold.png" alt=""  @click="shareShowClick(scope)"  v-if="shareShow!=scope.$index">
                            <img class="icon" src="@/assets/imgs/common/pack_up.png" alt="" @click="shareShowClick(scope)" v-else>
                            {{rs.channel_agency}}:</div>
                        </el-col>
                        <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                          <div class="content">{{scope.row.fullname}}</div>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="4" :lg="4" :xl="4">
                          <div class="title">{{rs.commission_rate_option}}:</div>
                        </el-col>
                        <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                          <el-select size="small" v-model="scope.row.option" :disabled="readonly" @change="getCommissData(scope.row.option,scope.row)">
                            <el-option
                      ...
                      <!-- <div v-if="shareShow==scope.$index"> -->
                        <el-row :gutter="5" class="line2">
                          <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                            <div class="title">{{rs.contact_person}}:</div>
                          </el-col>
                          ...
                          <!-- <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                            <span class="btntext" @click="uploadingContract(scope.row)" v-if="!readonly">{{rs.agreement}}</span>
                          </el-col> -->
                        </el-row>    
                        <el-row :gutter="5" class="line2">
                          <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                      ...
                      <!-- </div> -->
                        <el-row :gutter="5" class="line2">
                          <!-- <el-row :gutter="10" v-if="scope.row.option!='99'" style='padding: 5px 0;'> -->
                            <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                              <div class="title">{{rs.exchange_commission}}</div>
                            </el-col>
                            <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                          ...
                          <el-row :gutter="10" v-if="scope.row.option=='99'" style='padding: 5px 0;'>
                            <el-col :xs="24" :sm="10" :md="10" :lg="10" :xl="10">
                              ...
                              <el-row :gutter="5">
                                <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" v-show="isEdit==scope.$index">
                                ...
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-input size="small" v-model="scope.row.exchange.commissionrate" :disabled="readonly"  v-show="isEdit==scope.$index"></el-input>
                                  </div>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-select size="small" v-model="scope.row.exchange.ratetype" :disabled="readonly"  v-show="isEdit==scope.$index">
                                      <el-option
                              ...
                              <el-row :gutter="5">
                                ...
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-input size="small" v-model="scope.row.exchange.bonus" :disabled="readonly"  v-show="isEdit==scope.$index"></el-input>
                                  </div>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-select size="small" v-model="scope.row.exchange.bonustype" :disabled="readonly"  v-show="isEdit==scope.$index">
                                      <el-option
                                        v-for="item in optionsList"
                                        :key="item.value"
                                        :label="item.value"
                            ...
                            <el-col :xs="24" :sm="10" :md="10" :lg="10" :xl="10">
                              ...
                              <el-row :gutter="5">
                                ...
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-input size="small" v-model="scope.row.settled.commissionrate" :disabled="readonly"  v-show="isEdit==scope.$index"></el-input>
                                  </div>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-select size="small" v-model="scope.row.settled.ratetype" :disabled="readonly"  v-show="isEdit==scope.$index">
                                      <el-option
                                        v-for="item in optionsList"
                                        :key="item.value"
                                        :label="item.value"
                              ...
                              <el-row :gutter="5">
                                ...
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-input size="small" v-model="scope.row.settled.bonus" :disabled="readonly"  v-show="isEdit==scope.$index"></el-input>
                                  </div>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
                                  <div class="content">
                                    <el-select size="small" v-model="scope.row.settled.bonustype"  :disabled="readonly" v-show="isEdit==scope.$index">
                                    <el-option
                                      v-for="item in optionsList"
                                      :key="item.value"
                                      :label="item.value"
                            ...
                            <el-col :xs="24" :sm="12" :md="4" :lg="4" :xl="4">
                              <span class="btntext" @click="commisEdit(scope)" v-if="!readonly" v-show="show&&scope.row.option=='99'">{{rs.edit}}</span>
                            </el-col>
                            <el-col :xs="24" :sm="4" :md="4" :lg="4" :xl="4">
                              <span class="btntext" @click="commisSave(scope.row)" v-if="!readonly&&isEdit==scope.$index" >{{rs.save}}</span>
                              <span class="btntext" @click="cancel(scope.row)" v-if="!readonly&&isEdit==scope.$index" >{{rs.cancel}}</span>
                            </el-col>
                          </el-row>  
                        -->
                    </template>
        ...
        <el-col :span="24">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <!-- @selection-change="chengCheckbox" -->
              <div class="table_box">
                <el-table
                  ...
                  <el-table-column
                    ...
                    align="center">
                    <template slot-scope="scope">
                      <el-checkbox  v-model="ifbox[scope.row.code]" @change="chengCheckbox(ifbox[scope.row.code],scope.row)"></el-checkbox>
                    </template>
                  </el-table-column>
                  <el-table-column
                    prop=""
        ...
        <el-row>
          <el-col :offset="12" :span="12">
            <div class="filter-search" style="padding-bottom:15px">
              <el-input :placeholder="rs.search_agencies" @change="getData('0')"  v-model="data.condition" 
...
export default{
  ...
  created(){
    ...
    console.log('shareable -- 取',this.shareable)
  ...
  methods:{
    ...
    allchengCheckbox(val){
      if(val){
        this.approvalRouteList.forEach(element => {
          this.chengCheckbox(1,element);
        });
      }else{
        this.approvalRouteList.forEach(element => {
          this.chengCheckbox(0,element);
        });
      }
    },
    chengCheckbox(val,row){
      if (val) {
        val = '1'
      } else {
        val = '0'
    ...
    //         bonus:0
    //         }
    //     this.shareToList.forEach(ele => {
    //       if (row.agencyprojectid == ele.agencyprojectid) {
    //           ele.exchange = data1
    //           ele.settled = data2
    //       } 
    //     });
    ...
    //     }
    //     commissionInsertAgencyprojectCommission(data).then(res=>{
    //       if (res.data.success) {
    //         this.allList()
    //       } else {
    //         this.$message.error({dangerouslyUseHTMLString:true,message:this.ErrorMsgStr(res.data.data)});
    ...
    //          let data = {
    //           agencycommissionlist:JSON.stringify({exchange:ele.exchange,settled:ele.settled,option:row.option}),
    //           option:row.option,
    //           agencyprojectid:row.agencyprojectid,
    //           vendorid:JSON.parse(sessionStorage.getItem('vendorid')),
    //         }
    ...
    // cancel(row){
    //   this.shareToList.forEach((ele,i) => {   
    //     if(row.agencyprojectid == ele.agencyprojectid){
    //       for (const key in JSON.parse(this.oldArr)[i]) {
    //        ele[key] = JSON.parse(this.oldArr)[i][key]
    //       }
    //     }
    //   });
    //   this.isEdit = null
    ...
    allList(){
      ...
      getSharetoList(data).then(res=>{
        if (res.data.success) {         
          ...
          console.log(res.data.data,'shareToList - 取')
